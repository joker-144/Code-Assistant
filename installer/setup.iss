...
[Icons]
; 开始菜单
Name: "{group}\DevAgent"; Filename: "{app}\{#MyAppExeName}"; Parameters: "desktop"; WorkingDir: "{app}"; IconFilename: "{app}\{#MyAppExeName}"
; 桌面快捷方式
Name: "{autodesktop}\DevAgent"; Filename: "{app}\{#MyAppExeName}"; Parameters: "desktop"; WorkingDir: "{app}"; IconFilename: "{app}\{#MyAppExeName}"; Tasks: desktopicon
; 卸载
